...
export default function LoginPage() {
  return (
    <main className="min-h-screen mesh-gradient noise flex items-center justify-center p-4 relative overflow-hidden">
      {/* Background decorations */}
      <div className="absolute top-20 left-20 w-72 h-72 bg-purple-500/20 rounded-full blur-3xl animate-float" />
      <div className="absolute bottom-20 right-20 w-96 h-96 bg-pink-500/20 rounded-full blur-3xl animate-float animation-delay-400" />
      ...
      <div className="relative w-full max-w-md">
        {/* Card */}
        <div className="bg-card/80 backdrop-blur-xl rounded-3xl border border-border/50 shadow-2xl p-8 md:p-10">
          {/* Logo */}
          ...
          <div className="space-y-4">
            <Button 
              variant="outline" 
              className="w-full h-14 text-base font-medium border-2 hover:bg-secondary hover:border-primary/50 transition-all group"
